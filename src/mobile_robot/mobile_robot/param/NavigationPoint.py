...
ORCHARD_CORRIDOR_EXIT_1_CORRECTIVE_POINT = CorrectivePoint(1.93, -0.42, 0, [Corrective(Direction.LEFT, 0.2 + 0.222), Corrective(Direction.BACK, 0.21 + 0.222)])
...
ORCHARD_3_POINT = NavigationPoint(1.93, -1.09, 90)
ORCHARD_4_POINT = NavigationPoint(2.73, -2.59, 90)
ORCHARD_5_POINT = NavigationPoint(2.73, -1.84, 90)
