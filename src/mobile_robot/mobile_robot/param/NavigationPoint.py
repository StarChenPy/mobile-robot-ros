...
ORCHARD_CORRIDOR_ENTER_1_CORRECTIVE_POINT = CorrectivePoint(1.92, -3.45, 90, [Corrective(Direction.BACK, 0.555), Corrective(Direction.LEFT, 0.416)])
...
WAREHOUSE_2_POINT = NavigationPoint(0.56, -0.34, 180)
WAREHOUSE_3_POINT = NavigationPoint(0.56, -0.22, 180)

# 果园坐标
ORCHARD_CORRIDOR_ENTER_1_POINT = NavigationPoint(1.92, -3.65, 90)
ORCHARD_CORRIDOR_EXIT_1_POINT = NavigationPoint(1.92, -0.42, -90)

ORCHARD_CORRIDOR_ENTER_2_POINT = NavigationPoint(2.74, -3.65, 90)
ORCHARD_CORRIDOR_EXIT_2_POINT = NavigationPoint(2.74, -0.36, -90)
...
ORCHARD_4_POINT = NavigationPoint(2.74, -2.59, 90)
ORCHARD_5_POINT = NavigationPoint(2.74, -1.82, 90)
