...
TREE_2_TO_TREE_2 = (param.get_navigation_point("orchard_enter_a_fruit_tree_2"),
                    ...
                    param.get_navigation_point("orchard_enter_b_1_corrective"),
...
TREE_2_TO_TREE_3 = (param.get_navigation_point("orchard_enter_b_4"),
                    param.get_navigation_point("orchard_enter_b_3"),
                    param.get_navigation_point("orchard_enter_b_fruit_tree_3"))

TREE_3_TO_TREE_4 = (param.get_navigation_point("orchard_enter_b_3"),
                    param.get_navigation_point("orchard_enter_b_4"),
                    param.get_navigation_point("orchard_enter_b_3"),
                    param.get_navigation_point("orchard_enter_b_fruit_tree_4"))

TREE_4_TO_TREE_START = (param.get_navigation_point("orchard_enter_b_2"),
                        param.get_navigation_point("orchard_enter_b_2_corrective"),
                        param.get_navigation_point("orchard_enter_b_1"),
                        param.get_navigation_point("start_enter_point"),
