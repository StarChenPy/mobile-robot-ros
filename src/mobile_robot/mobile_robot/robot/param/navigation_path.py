...
ORCHARD_ENTER_1_POINT = Pose(0.5, -3.7, 0)
ORCHARD_ENTER_2_POINT = Pose(2, -3.7, 90)
ORCHARD_1_POINT = Pose(2, -2.95, 90)
...
class NavPath(enum.Enum):
    ...
    B_MODULE_6 = (NavigationPoint(ORCHARD_ENTER_2_POINT), NavigationPoint(ORCHARD_ENTER_1_POINT),
    ...
    B_MODULE_7 = (NavigationPoint(START_POINT, Corrective(CorrectiveSensor.PING, 20)),
                  NavigationPoint(START_ENTER_POINT), NavigationPoint(ORCHARD_ENTER_1_POINT),
                  NavigationPoint(ORCHARD_ENTER_2_POINT), NavigationPoint(ORCHARD_1_POINT))
    ...
    B_MODULE_12 = (NavigationPoint(ORCHARD_ENTER_1_POINT),
                   NavigationPoint(ORCHARD_ENTER_1_POINT, Corrective(CorrectiveSensor.PING, 30)),
