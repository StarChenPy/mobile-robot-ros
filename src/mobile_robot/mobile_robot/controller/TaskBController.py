    ...
    def task_4(self):
        ...
        while self.move.get_status():
            ...
            if grape:
                self.move.stop_navigation()
                for i in range(10):
                    if self.grab_grape(grape, Direction.RIGHT):
                        ArmMovement.motion(self.arm)
                        return
